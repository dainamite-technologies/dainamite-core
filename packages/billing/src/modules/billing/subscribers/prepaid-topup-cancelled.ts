...
/**
 * Subscriber: `payment_gateways.payment.cancelled` → BillingTopup → cancelled.
 * No-op for any non-top-up payment. No balance movement.
 */

export const metadata = {
  event: 'payment_gateways.payment.cancelled',
  persistent: true,
  id: 'billing-prepaid-topup-cancelled',
}
