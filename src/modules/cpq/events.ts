 ...
 * CPQ Module Events.
 *
 * Currently only the XD-250 ARC (Amend / Renew / Cancel) lifecycle events
 * are declared here. Downstream modules (billing, notifications) subscribe
 * to these to react to subscription mutations driven by CPQ orders.
 *
